...
export const createCharacter = async (
  ...
  const { data: character, error } = await supabaseAdmin
    ...
    .insert({
      ...
      stamina: 10,
      attack_power: classData.primary_stat === 'strength' ? 20 : 5,
      spell_power: classData.primary_stat === 'intellect' || classData.primary_stat === 'spirit' ? 20 : 5,
      armor: classData.primary_stat === 'strength' ? 10 : 5,
      gold: 0,
      honor_points: 0,
      arena_rating: 1500,
